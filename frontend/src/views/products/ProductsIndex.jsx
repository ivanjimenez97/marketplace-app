...
export default function ProductsIndex() {
  ...
  const getRecords = async (url = "/products", keyword = "") => {
    setLoading(true);
    try {
  ...
  const onDelete = () => {
    ...
    axiosClient
      .delete(`/products/${selectedRecord.id}`)
      .then(() => {
    ...
    <div className="mt-5">
      <div className="flex flex-row mb-5">
        <div className="basis-1/2 my-auto">
          <PageTitle classes={"mb-0"} title={"Products"} />
        </div>
            ...
            <table className="w-full table-auto border-collapse border">
              <thead>
                <tr className="border-b font-bold">
                  ...
                  <th className="py-3 border text-center">Name</th>
                  <th className="py-3 border text-center">SKU</th>
                  {parseInt(user.roleId) === 1 && <th className="py-3 border text-center">Owner</th>}
              ...
              <tbody>
                {records.map((record, index) => (
                  <tr key={index} className="">
                    ...
                    {parseInt(user.roleId) === 1 && <td className="py-1 px-3 border text-center">
      ...
      >
        ...
        <p className="font-normal text-center">
          <b>SKU:</b> <br />
          {selectedRecord && selectedRecord.sku}
        </p>
        <p className="font-normal text-center">
